...
async def accept(client, message):
    ...
    chatz = await client.listen(message.chat.id)
    if chatz.forward_from_chat and not chatz.forward_from_chat.type in [enums.ChatType.PRIVATE, enums.ChatType.BOT]:
        chat_id = chatz.forward_from_chat.id
        try:
